  ...
  try {
    ...
    if (!brandId) {
      return NextResponse.json({
        metricsOverTime: [],
        comparison: {
          roas: { current: 0, previous: 0, change: null },
          ctr: { current: 0, previous: 0, change: null },
          cpc: { current: 0, previous: 0, change: null },
          spend: { current: 0, previous: 0, change: null },
          conversions: { current: 0, previous: 0, change: null },
        },
      });
    }
