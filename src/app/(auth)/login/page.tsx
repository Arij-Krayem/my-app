...
export default function LoginPage() {
  ...
  const readErrorMessage = async (res: Response) => {
    ...
    if (text.includes("Cannot find module '.prisma/client/default'")) {
      return "The server needs a restart after Prisma client generation. Please refresh the dev server and try again.";
    }

    return res.status >= 500
      ? "The server returned an HTML error page instead of JSON. Please try again after the API server finishes reloading."
